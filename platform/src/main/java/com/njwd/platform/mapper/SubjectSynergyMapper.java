...
public interface SubjectSynergyMapper extends BaseMapper<SubjectSynergy> {
	...
	int deleteSubjectSynergy(@Param("subjectSynergyDto") SubjectSynergyDto subjectSynergyDto,@Param("subjectSynergyList") List<SubjectSynergyVo> subjectSynergyList);
