...
@Component
@Log
@ExcelExtend(type = "supplier")
public class SupplierExtend implements AddExtend<CustomerSupplierDto>, CheckExtend {
    ...
    private void setCommand(CustomerSupplierDto customerSupplierDto) {
        customerSupplierDto.setDataType(Constant.CustomerSupplier.SUPPLIER);
        customerSupplierDto.setIsInternalSupplier(Constant.CustomerSupplier.IS_INTERNAL_NO.toString());
    }
    ...
    public void check(CheckContext checkContext) {
        ...
        checkContext.addSheetHandler("companyName", getCompanyNameHandler(isEnterpriseAdmin)).
                addSheetHandler("supplierType", getTypeHandler()).
    ...
    private CheckHandler<CustomerSupplierDto> getTypeHandler() {
        return (data) -> {
            System.err.println(data.getSupplierType());
            if (Constant.CustomerSupplier.ENTERPRISE.toString().equals(data.getSupplierType())) {
                data.setIdCardNum(null);
            }
            if (Constant.CustomerSupplier.PERSONAL.toString().equals(data.getSupplierType())) {
